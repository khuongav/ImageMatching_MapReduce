...
/**
 * This is a fast implementation of the Skein-512-512 hash function. All other modes are not tested
 * and supported. It is compatible with the revised reference implementation (1.3).
 * <p>
 * Author: Thomas Mueller, 2008-2010 based on the C reference implementation written by Doug
 * Whiting, 2008.
 * <p>
...
public class Skein512 {
  ...
  private long getLong(byte[] b, int i) {
    ...
    return (((b[i] & 255) + ((b[i + 1] & 255) << 8) + ((b[i + 2] & 255) << 16)
